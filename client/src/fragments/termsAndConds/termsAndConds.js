...
import { TermsAndCondsFragmentStyed } from "./styles";
import { MainNavBar } from "..";

export const TermsAndCondsFragment = () => {
   return (
      <TermsAndCondsFragmentStyed>
         <div className="terms-and-conds">
            <div className="terms-and-conds__container">
               <h6 className="terms-and-conds__logo">SoCal Air Systems</h6>
               <MainNavBar />
            </div>
         </div>
         <div className="terms-and-conds-container">
            <div className="terms-and-conds-box">
               <div className="terms-and-conds-title-box">
                  <h2 className="terms-and-conds-title">{"Terms & Conditions"}</h2>
                  <TitleDivider />
               </div>
