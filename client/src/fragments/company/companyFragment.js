                     ...
                     <section className="who-we-are-box">
                        ...
                        <div className="who-we-are-info-box">
                           ...
                           <p className="who-we-are-description">
                              We are a group of professional HVAC technicians and project managers
                              that strive to provide the highest quality work at a fair price. Being
                              local and serving the local community, we have become adept in
                              recognizing issues and providing solutions within a short timeframe.{" "}
                           </p>
                           <p className="who-we-are-description">
                              SoCal Air is still family owned and operated so you can expect a
                              personal touch to every project as well as customer service that
                              cannot be matched by large corporations.
                           </p>
                        </div>
                     </section>
                     <MeetOurFounder />
